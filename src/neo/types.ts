...
export enum PowerState { ON = 'ON', OFF = 'OFF', UNKNOWN = 'UNKNOWN' }
export enum ClimateMode { AUTO = 'AUTO', COOL = 'COOL', HEAT = 'HEAT', FAN = 'FAN', UNKNOWN = 'UNKNOWN' }
export enum CompressorMode { COOL = 'COOL', HEAT = 'HEAT', OFF = 'OFF', UNKNOWN = 'UNKNOWN' }
...
export enum NeoCommand {
  ...
  AFTER_HOURS_ON = 'AFTER_HOURS_ON',
  AFTER_HOURS_OFF = 'AFTER_HOURS_OFF',
